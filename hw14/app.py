...
def create_interface():
    ...
    with gr.Blocks(
        ...
        with gr.Tab("⚙️ Адміністрування"):
            ...
            with gr.Row():
                process_btn = gr.Button("📚 Обробити всі 10000 книг", variant="primary")
                upload_btn = gr.Button("☁️ Завантажити в Firestore", variant="secondary")
        ...
        with gr.Tab("ℹ️ Довідка"):
            ...
            <div style="padding: 20px; font-family: Georgia, serif; line-height: 1.8;">
                ...
                <ul>
                    ...
                    <li><strong>Deepseek API</strong> - для генерації відповідей (опціонально)</li>
                    <li><strong>Google Firestore</strong> - для зберігання векторів</li>
                </ul>
                
                <h4>4. 🎭 Доступні жанри</h4>
                <p>Новинки, Дитяча література, Нехудожня література, Художня література, Серія книг та інші.</p>
            </div>
            """)
